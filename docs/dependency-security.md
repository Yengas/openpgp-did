...
- `RUSTSEC-2025-0009`, `RUSTSEC-2026-0098`, `RUSTSEC-2026-0099`, and `RUSTSEC-2026-0104` are present only through SSI VC's built-in HTTP status client. The CLI never calls that client. Its verification code fetches DID documents and status lists with the direct `reqwest` 0.12 dependency and the bounded public-HTTPS policy described in the [design notes](./design.md).
